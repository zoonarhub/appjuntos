...
const ProtectedRoute = ({ children }: { children: React.ReactNode }) => {
  ...
  if (isLoading) {
    return <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#030712', color: 'white' }}>Carregando...</div>;
  }
  
  if (!dbUser?.status_acesso) {
